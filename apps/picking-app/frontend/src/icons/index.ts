...
import BoxTapped from "./box-tapped.svg?react";
import TruckDelivery from "./truck-delivery.svg?react";
import BoxMoving from "./box-moving.svg?react";
import AiIcon from "./ai-icon.svg?react";
import CartIcon from "./cart-icon.svg?react";
import CallIcon from "./call-icon.svg?react";
import DashboardAltIcon from "./dashboard-alt.svg?react";
import CalendarAltIcon from "./calendar-alt.svg?react";
import ProfileAltIcon from "./profile-alt.svg?react";
import ChartAltIcon from "./chart-alt.svg?react";
import CubeAltIcon from "./cube-alt.svg?react";
import EmailAltIcon from "./email-alt.svg?react";
import InboxAltIcon from "./inbox-alt.svg?react";
import HeadphoneAltIcon from "./headphone-alt.svg?react";
import SettingsAltIcon from "./settings-alt.svg?react";
import IntegrationAltIcon from "./integration-alt.svg?react";
import BellAltIcon from "./bell-alt.svg?react";
import UserMoneyIcon from "./user-money.svg?react";
import MultiUserIcon from "./multi-user.svg?react";
import FilesIcon from "./files.svg?react";
import DollarIcon from "./dollar.svg?react";
import PlusAltIcon from "./plus-alt.svg?react";
import MinusAltIcon from "./minus-alt.svg?react";
